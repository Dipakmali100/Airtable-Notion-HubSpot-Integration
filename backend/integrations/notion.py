...
# Get these notion credentials from this site -> https://www.notion.so/profile/integrations
CLIENT_ID = 'XXX'
CLIENT_SECRET = 'XXX'
...
async def get_items_notion(credentials) -> list[IntegrationItem]:
    ...
    if response.status_code == 200:
        ...
        print(f'list_of_contact_integration_item_metadata: {list_of_integration_item_metadata}')
